    ...
    <div>
      <section className="container mb-24 px-4 mx-auto ">
        <div className="flex justify-between items-end">
          ...
          <Lottie
            className="w-36 relative top-8 right-6"
            animationData={add}
          ></Lottie>
        </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 ">
                    {foods?.map((food) => (
                      <tr key={food._id} className="bg-[#108864]/5">
                        ...
                        >
                          {food?.note.slice(0, 32)}...
                        </td>
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex items-center gap-x-6">
                            <Link
                              to={`/update/${food._id}`}
                              className="text-black/80 transition-colors bg-[#108864] p-1 rounded-full text-white duration-200   hover:text-yellow-500 focus:outline-none"
                            >
                              <svg
                            ...
                            <button
                              ...
                              className="text-black/80 transition-colors duration-200   hover:text-red-500 focus:outline-none"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
