    ...
    return (
        <div>
            <div className='py-4 w-[90%] md:w-[93%] font-outfit mx-auto max-w-7xl px-0'>
                ...
                <div className='text-left font-mons mt-20'>
                ...
                <div className="flex items-center justify-end mt-16">
                    ...
                    <div className='flex mx-24 items-center gap-3 justify-center'>
                        <p>Sort By: </p>
                        <select
                ...
                <div className="grid lg:grid-cols-3 mt-16 md:grid-cols-2 grid-cols-1  gap-5">
                    {
