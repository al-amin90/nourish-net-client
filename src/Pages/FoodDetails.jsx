    ...
    <div className="bg-[#F4F4F4]">
      <div className="max-w-7xl grid py-24 mb-12 grid-cols-1 lg:grid-cols-3 mx-auto w-[90%]  md:w-[85%]">
        ...
        <div className="text-[#303544]">
          <h1 className="font-extrabold text-[#303544]   text-3xl">
            {data?.foodName}
          </h1>
          <div className="text-[#717C7D] flex mt-5">
            <p className="text-base mr-4 ">
              {" "}
              <span className="text-[#108864] font-medium">
                {" "}
                Donate By:
              </span>{" "}
              {data?.donateUser?.name}
            </p>
            <p className="flex items-center gap-2">
              <FaLocationDot className="text-[#108864]" />{" "}
              {data?.locationPickup}
            </p>
          </div>
          <div className="bg-white rounded-xl mt-3 pt-5">
            <div className="flex justify-between border-b pb-4 px-6">
              <div>
                <p className="text-xs font-medium text-[#A2AAAB]">
                  ● Expired Date
                </p>
                <p className="text-2xl flex items-center mt-1 font-bold text-[#108864]">
                  <LuClock className="text-sm mr-2" />
                  {data?.AVGCost}
              ...
              <div>
                ...
                <p className="text-2xl flex items-center mt-1 font-bold text-[#108864]">
                  <GiFruitBowl className="text-sm mr-2" />
                  {data?.AVGCost}
                  <span className="text-black/90 text-sm font-medium ">
                    {" "}
                    {data.foodQuantity}
            ...
            <div className="px-6 flex items-center justify-end mt-4">
              ...
              <Button
                ...
                className="py-4 px-5 text-base border-2 border-[#303544] hover:text-[#303544] text-white duration-300 hover:bg-white bg-[#303544] rounded-full flex items-center gap-2 hover:shadow-xl font-medium"
