  ...
  return (
    <div className="  ">
      ...
      >
        <SwiperSlide>
          <div
            className="md:h-[calc(100vh-50px)] h-[400px] bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: `url(https://i.ibb.co/bJrHkWj/prothomalo-english-import-media-2016-05-05-93a7e1c3d2b726baf5a70514aa2ace7f-grapes-690230-960-720.jpg)`,
            }}
          >
              ...
              >
                <div className=" mt-10 md:mt-0 text-white w-full md:w-auto">
                  <p className="text-2xl md:text-3xl lg:text-3xl w-11/12 font-bold text-center md:text-left">
                    Together, Let's{" "}
                    <span className="text-[#25d4a0]">Share</span> Foods Souls!
        ...
        <SwiperSlide>
          <div
            className="md:h-[calc(100vh-50px)] z-0 h-[400px] bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: `url(https://i.ibb.co/DWCZsw1/pommes-arbre-au-soleil-900321-11750.jpg)`,
            }}
          >
            <div className="bg-white/20 md:backdrop-blur-md md:w-1/3 rounded-3xl relative top-1/2 md:left-24 -translate-y-1/2 h-2/3 bg-opacity-60">
              <motion.div
              ...
              >
                <div className=" mt-10 md:mt-0 text-white w-full md:w-auto">
                  <p className="text-2xl md:text-3xl lg:text-3xl w-11/12 font-bold text-center md:text-left">
                    Sharing Food,{" "}
                    <span className="text-[#303544]">Reducing</span> Waste!
                  </p>
                  <p className="font-medium mt-5 text-sm md:text-base text-center md:text-left">
