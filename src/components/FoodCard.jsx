    ...
    return (
        <div className="min-h-full">
            <div className="card min-h-full rounded-2xl bg-white dark:bg-white/90 card-compact font-open shadow-lg">
                <figure className="md:h-60 border w-full h-[250px] rounded-xl bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${foodURL})` }}>

                </figure>
                <div className="relative px-6 mt-5">

                    <div className="font-md flex items-center justify-between">
                        <h2 className="text-2xl pt-4 dark:text-black/70 font-bold"> {foodName}</h2>
                        <div className="text-center">
                            <span className="py-2 text-base text-white px-4 rounded-xl bg-[#108864]">{foodQuantity}</span>
                    ...
                    <div className="border-t pt-3">
                        ...
                        <div className="justify-between text-lg items-center flex">
                            <h2 className="font-semibold text-[#108864]">{donateUser?.name}</h2>
                        ...
                        <p className="pb-6  mt-2"><span className="font-semibold">Note:</span> {note}</p>
                    </div>
