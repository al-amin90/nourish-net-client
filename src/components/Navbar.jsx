      ...
      <div className="bg-[#EEFFF5]">
        <div className="navbar py-4 w-[95%] font-outfit mx-auto max-w-7xl px-0 ">
          <div className="navbar-start">
            <div className="flex ">
              <div className="flex gap-2 items-center justify-center text-lg">
                ...
                <p className="text-[#023022] font-mons font-bold pt-3">
                  NourishNet
                </p>
              </div>
              <label className="border hidden md:flex ml-24 px-3 w-60 relative rounded-full input-bordered items-center gap-2">
                ...
                <input
                  type="text"
                  className="grow text-sm rounded-full outline-none h-full"
                  placeholder="Name"
                />
                <button className="px-5 absolute text-sm right-0 h-full bg-[#023022] text-white hover:bg-[#023022]/85 rounded-full">
                  Search
                </button>
              </label>
            </div>
          ...
          <div className="navbar-end items-center gap-7">
            ...
            {user ? (
              <div className="dropdown cursor-pointer  z-50 dropdown-end dropdown-hover">
                ...
                >
                  <li className="pb-4 py-2 px-2 font-bold text-base">
                    {user?.displayName}
                  </li>
                  <li
                    onClick={handleLogOut}
                    className="bg-[#023022] rounded-b-2xl text-white rounded-md"
                  >
                    <p>
                      Logout <MdOutlineLogin className="text-xl" />
                    </p>
                  </li>
                </ul>
              </div>
        ...
        <div className="navbar w-[95%] mx-auto justify-between pt-2 max-w-7xl px-0">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className={
                "flex items-center gap-2 border-2 rounded-md mr-3 px-2 text-base text-[#254F42]  font-bold hover:border-b-2 py-1 bg-white hover:shadow-md "
              }
            >
